...
function showResults() {
    ...
    if (score >= 800) {
        ...
        resultText.innerText = `Félicitation!! Vous avez réussi la simulation de l'examen "W3Schools Certifications". On espère que vous passeriez l'examen réel de certification, bonne change!!`
    } else {
        result.innerText = 'Fail'
        result.style.color = "rgb(201,86,58)"
        resultText.innerText = `Malheureuxement vous n'avez par réussi la simulation de l'examen " W3Schools Certifications", n'bandonnez pas!! Bonne change pour l'examen réel!!`
